        ...
        if (object && (typeof object == 'object')) {
            if (object._icebox_frozen) {
                ...
                if (object.constructor == undefined) {
                   console.log("object constructor is undefined", object);
                }
                if (object.constructor.name && !object.constructor.name.match(/^(Array|Object)$/)) {
                ...
                if (object.constructor.name == 'Date') {
                    ...
                    for (var prop in object) {
                        if (object.hasOwnProperty(prop) && prop != '_icebox_constructorName') {
                            if(object[prop] == null || object[prop].constructor == null) {
                                frozen[prop] = null;
                            } else {
